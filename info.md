...
1. Click install.
1. In the HA UI go to "Configuration" -> "Integrations" click "+" and search for "Zendure ZenSDK Integration".
...
[license]: https://github.com/flattman/zendure-zensdk-integration/blob/main/LICENSE
